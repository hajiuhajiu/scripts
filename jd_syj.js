...
!(async () => {
  ...
  const list1 = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_zz.json') || []
  $.authorTuanList = [...$.authorTuanList,...list1]
  // await getRandomCode();
