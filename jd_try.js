...
let args_xh = {
     ...
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [1,2,3,4,5,6,7,8,9,101,102,103,104,105,106,107,108,109,111,110,200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212],
    /*
     ...
     * */
    titleFilters: process.env.JD_TRY_TITLEFILTERS && process.env.JD_TRY_TITLEFILTERS.split('@') || ['牛奶@手机@电脑@家电@零食'],
    /*
     ...
     * */
    trialPrice: process.env.JD_TRY_TRIALPRICE * 1 || 20,
    /*
